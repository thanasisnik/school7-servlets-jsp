                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input id="firstname" name="firstname" type="text"
                               value="${fn:escapeXml(not empty requestScope.studentInsertDTO.firstname ? requestScope.studentInsertDTO.firstname : '')}"
                    ...
                    <div>
                        ...
                        <input id="lastname" name="lastname" type="text"
                               value="${fn:escapeXml(not empty requestScope.studentInsertDTO.lastname ? requestScope.studentInsertDTO.lastname : '')}"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input id="fathername" name="fathername" type="text"
                               value="${fn:escapeXml(not empty requestScope.studentInsertDTO.fatherName ? requestScope.studentInsertDTO.fatherName : '')}"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input id="phoneNum" name="phoneNum" type="text"
                               value="${fn:escapeXml(not empty requestScope.studentInsertDTO.phoneNum ? requestScope.studentInsertDTO.phoneNum : '')}"
                    ...
                    <div>
                        ...
                        <input id="email" name="email" type="text"
                               value="${fn:escapeXml(not empty requestScope.studentInsertDTO.email ? requestScope.studentInsertDTO.email : '')}"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input id="street" name="street" type="text"
                               value="${fn:escapeXml(not empty requestScope.studentInsertDTO.street ? requestScope.studentInsertDTO.street : '')}"
                    ...
                    <div>
                        ...
                        <input id="streetNum" name="streetNum" type="text"
                               value="${fn:escapeXml(not empty requestScope.studentInsertDTO.streetNum ? requestScope.studentInsertDTO.streetNum : '')}"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input id="zipcode" name="zipcode" type="text"
                               value="${fn:escapeXml(not empty requestScope.studentInsertDTO.zipCode ? requestScope.studentInsertDTO.zipCode : '')}"
                    ...
                    <div>
                        ...
                        <select id="cityId" name="cityId"
                            ...
                            <option value="" disabled ${empty requestScope.studentInsertDTO.cityId ? 'selected' : ''}>
                                Επιλέξτε Πόλη
                            </option>
                            <c:forEach items="${requestScope.cities}" var="city">
                                <option value="${city.id}"
                                        ${city.id eq requestScope.studentInsertDTO.cityId ? 'selected' : ''}>

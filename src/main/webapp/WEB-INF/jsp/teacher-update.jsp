...
<div class="max-w-3xl mx-auto p-8 mt-6 bg-white border  shadow-lg rounded-xl">
	...
	<div class="mb-5">
		<form class="bg-gray-50 p-8 rounded-lg shadow-md" method="POST" action="${pageContext.request.contextPath}/school-app/teachers/update">
            ...
            <div class="flex justify-between gap-8 m-bottom">
                <input class="w-full border border-gray-300 rounded-md px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500" type="text" name="vat" value="${requestScope.updateDTO.vat}" placeholder="ΑΦΜ">
